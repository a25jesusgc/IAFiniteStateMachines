...
Engadín un novo **State** chamado **Hold**. Este estado é un estado intermedio entre **Pursue** e **Patrol**. Cando está perseguindo ao xogador, se o perde de vista, en lugar de volver a patrullar inmediatamente, mantén a posición uns segundos ata volver a patrullar ou ata que vexa de novo ao xogador.
...
No método sobresctrito **Update**, se ve ao xogador de novo, volve ao estado **Pursue**, e senón, resta o tempo de espera ata que chegue a 0, momento no cal establece o seguinte estado a **Patrol** creando un novo obxecto **Patrol** e asignándollo ao **nextState** e cambia o *stage* a **Event.EXIT** para que se execute o método **Exit**.
